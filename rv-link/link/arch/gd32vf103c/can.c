...
#endif
#else
#error __SYSTEM_CLOCK_X_PLL_HXTAL not defined
#endif
...
static void can_eclic_config(void)
{
    ...
    // can_interrupt_flag_clear(CANX, CAN_FLAG_RFF0);
    // can_interrupt_flag_clear(CANX, CAN_FLAG_RFF1);
    // can_interrupt_flag_clear(CANX, CAN_FLAG_RFO0);
    // can_interrupt_flag_clear(CANX, CAN_FLAG_RFO1);

    // can_flag_clear(CANX, CAN_FLAG_RFF0);
    // can_flag_clear(CANX, CAN_FLAG_RFF1);
    // can_flag_clear(CANX, CAN_FLAG_RFO0);
    // can_flag_clear(CANX, CAN_FLAG_RFO0);
...
void CAN0_RX0_IRQHandler(void) {CAN1_RX0_IRQHandler();}
void CAN0_RX1_IRQHandler(void) {CAN1_RX1_IRQHandler();}
